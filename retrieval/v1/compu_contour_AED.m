function [ AED_feats ] = compu_contour_AED(euclid_dist_mat, n_contsamp)
...
for samp_point_idx = 1 : n_contsamp
    ...
    AED_feats(samp_point_idx, 1 : 2) = [AGD  square_mean_GD AED_variance];
    for percentile_idx = 1 : 9
        perc_point_idx = floor((percentile_idx / 10) * n_contsamp) ;  % 向量下标，向下取整
