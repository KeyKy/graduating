...
% load 'F:\\SCRecomDict\\15\\sketchInfos.mat' sketchInfos
...
%     end
% end
% save 'F:\\SCRecomDict\\15\\modelSketInfos.mat' modelSketInfos

load 'F:\\SCRecomDict\\15\\modelSketInfos.mat' modelSketInfos
n_model = length(modelSketInfos.keys());
...
save 'F:\\SCRecomDict\\15\\genRecomModelTable.mat' genRecomModelTable
